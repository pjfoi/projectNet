...
namespace UserInteface.Content
{
        ...
        : NotifyPropertyChanged
    {
        ...
        private const string FontLarge = "Groot";
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "Donker", Source = AppearanceManager.DarkThemeSource });
            this.themes.Add(new Link { DisplayName = "Licht", Source = AppearanceManager.LightThemeSource });
